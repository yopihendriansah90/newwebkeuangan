...
class TransactionInputNormalizerTest extends TestCase {
 ...
 public function test_normalizes_relative_and_partial_dates():void { $normalizer=new TransactionInputNormalizer(); $now=Carbon::create(2026,7,21,12); $this->assertSame('2026-07-20',$normalizer->date('kemarin',$now,7,2026)); $this->assertSame('2026-07-21',$normalizer->date('tadi',$now,7,2026)); $this->assertSame('2026-07-12',$normalizer->date('tanggal 12',$now,7,2026)); $this->assertSame('2026-06-05',$normalizer->date('tanggal 5 bulan lalu',$now,7,2026)); $this->assertSame('2026-09-12',$normalizer->date('12/09',$now,7,2026)); $this->assertSame('2019-06-22',$normalizer->date('22 Juni 2019',$now,7,2026)); $this->assertSame('2019-06-22',$normalizer->date('22 Jun 2019',$now,7,2026)); }
}
